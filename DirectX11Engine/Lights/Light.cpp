...
{
	return DirectX::XMMatrixOrthographicLH(Width, Height, 100.0f, 10000.0f);
}
...
DirectX::XMMATRIX PointLight::GetProjectionMatrix(float Width, float Height) const
{
	return DirectX::XMMatrixPerspectiveFovLH(PI / 2.0f, Width / Height, 5.0f, 5000.0f);
}
